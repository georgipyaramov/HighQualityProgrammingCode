...
namespace MatrixWalkTest
{
    ...
    public class MatrixWalkTest
    {
        ...
        public void TestPrintMatrix()
        {
            ...
            MatrixWalk.MatrixWalk.PrintMatrix(matrix);
        ...
        public void TestMainMetod()
        {
            ...
            StringBuilder sb = new StringBuilder();
            Console.SetOut(new System.IO.StringWriter(sb));
            MatrixWalk.MatrixWalk.Main();
            string matrixTostrng = @"Enter a positive number:
  1 16 17 18 19 20
 15  2 27 28 29 21
 14 31  3 26 30 22
 13 36 32  4 25 23
...
";
        ...
        public void TestMainMetodWithIncorrectMatrixSize()
        {
            ...
            MatrixWalk.MatrixWalk.Main();
            string matrixTostrng = @"Enter a positive number:
You haven't entered a correct positive number in [1, 100]
  1 16 17 18 19 20
 15  2 27 28 29 21
 14 31  3 26 30 22
 13 36 32  4 25 23
